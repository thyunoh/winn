...
public class MedDeviceDTO extends CommonDTO {
    ...
    private String lastInspectDt;
    private String nextInspectDt;
    ...
    public String getMakeDt() { return makeDt; }
    public void setMakeDt(String makeDt) { this.makeDt = makeDt; }

    public String getMakeNo() { return makeNo; }
    public void setMakeNo(String makeNo) { this.makeNo = makeNo; }
    ...
    public String getPurchaseDt() { return purchaseDt; }
    public void setPurchaseDt(String purchaseDt) { this.purchaseDt = purchaseDt; }

    public String getInspectCycle() { return inspectCycle; }
    public void setInspectCycle(String inspectCycle) { this.inspectCycle = inspectCycle; }

    public String getLastInspectDt() { return lastInspectDt; }
    public void setLastInspectDt(String lastInspectDt) { this.lastInspectDt = lastInspectDt; }

    public String getNextInspectDt() { return nextInspectDt; }
    public void setNextInspectDt(String nextInspectDt) { this.nextInspectDt = nextInspectDt; }
