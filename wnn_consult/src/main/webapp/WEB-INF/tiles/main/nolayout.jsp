...
function fnPwdChange(){ 
	...
	var popupwidth = '530';
	var popupheight = '370';  
	var url = "/user/pwdchg.do?user_id="+$("#user_id").val();   
    ...
    <div class="login-box">
      <div class="login-wrap">
        ...
        <div class="id-box w-100">
          ...
          <input type="password" class="form-control mt-3" id="user_pwd" placeholder="비밀번호" onKeypress="hitEnterKey(event);">
        </div>
