		...
		<div class="row px-xl-8">
			<div class="col-lg-3 d-none d-lg-block">
				<a
					...
					style="height: 80px; padding: 0; width: 70%;"> <img
					src="/images/winct/winner_log_han.png" alt="WinnerNet Logo"
					id="consultingTitle"
							...
							<div class="nav-item dropdown">
								...
								<div class="dropdown-menu bg-light rounded-0 border-0 m-0">
									<a href="#" class="dropdown-item"
										onclick="setActive(this); loadPage('/login/wnnpage_consult1.do')">의료기관컨설팅</a> <a href="#" class="dropdown-item"
										onclick="setActive(this); loadPage('/login/wnnpage_consult2.do')">재청구컨설팅</a> <a href="#" class="dropdown-item"
										onclick="setActive(this); loadPage('/login/wnnpage_consult3.do')">의료기관인증컨설팅</a> <a href="#" class="dropdown-item"
										onclick="setActive(this); loadPage('/login/wnnpage_consult4.do')">적정성평가컨설팅</a> <a href="#" class="dropdown-item"
										onclick="setActive(this); loadPage('/login/wnnpage_consult5.do')">현지조사컨설팅</a>
								</div>
							</div>
							<a href="https://winner797.net/" class="nav-item nav-link" style="font-size: 17px;">온라인교육센터</a>
							<a href="#" class="nav-item nav-link" style="font-size: 17px;">경영분석 프로그램</a> 
							<a href="#" class="nav-item nav-link" style="font-size: 17px;">적정성평가 프로그램</a>
						</div>
					...
					<div class="carousel-inner">
						<div class="carousel-item position-relative active"
							...
							<img class="position-absolute w-100 h-100"
								src="/images/winct/image-1.jpg" style="object-fit: fill;">
							<div
						...
						<div class="carousel-item position-relative"
							style="height: 530px;">
							<img class="position-absolute w-100 h-100"
								src="/images/winct/image-2.jpg" style="object-fit: fill;">
							<div
								class="carousel-caption d-flex flex-column align-items-center justify-content-center">
								<div class="p-3" style="max-width: 700px;"></div>
							</div>
						...
						<div class="carousel-item position-relative"
							style="height: 530px;">
							<img class="position-absolute w-100 h-100"
								src="/images/winct/image-3.jpg" style="object-fit: fill;">
							<div
								class="carousel-caption d-flex flex-column align-items-center justify-content-center">
								<div class="p-3" style="max-width: 700px;"></div>
							</div>
			...
			<div class="col-lg-4">
				<div class="bg-light box-p-5 mb-2">
					<div class="control-group">
						<button
							class="btn btn-block btn-blue   text-md-left font-weight-bold my-2 py-2">위너넷
							컨설팅 통합 가이드북. Open &raquo;&raquo;&raquo;</button>
					</div>
					<div class="control-group">
						<button
							class="btn btn-block btn-blue text-md-left font-weight-bold my-2 py-2">위너넷
							온라인 교육 바로가기. &raquo;&raquo;&raquo;</button>
					</div>

				</div>
				<h5 class="section-title position-relative text-muted mb-1">
				...
				<div class="contact-form bg-light box-p-10 mb-3">
					<form name="loginForm" id="loginForm">
						...
						<div>
							<button type="button"
								class="btn btn-block btn-blue text-center font-weight-bold my-2 py-2"
								id="blogin" onClick="login()">로그인</button>
						</div>
						<div class="row">
							<div class="col-4">
								<button type="button"
									class="btn btn-block btn-outline-dark text-center font-weight-bold my-1 py-2"
									onclick="fnmbrReg();">회원가입</button>
							</div>
							<div class="col-4">
								<button type="button"
									class="btn btn-block btn-outline-dark text-center font-weight-bold my-1 py-2"
									onclick="fnPasswdmanager();">ID/PW찾기</button>
							</div>
							<div class="col-md-4">
					...
					<div id="userInfoCard"
						style="display: none; overflow: auto; max-height: 200px;">
						<div class="user_card">
					...
					<div class="row">
						<div class="col-12">
							<a href="#"> <img class="img-fluid"
								src="/images/winct/wincheck-02.png" alt="wincheck" href="#">
							</a>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-4">
							<a href="https://open.kakao.com/o/gBvFxyYg"> <img
								class="img-fluid" src="/images/winct/KKO_10_1.png" alt="카카오상담"
								href="#">
							</a>
						</div>
						<div class="col-4">
							<a href="#" onclick="fnasq_main();"> <img class="img-fluid"
								src="/images/winct/1-1_10_1.png" alt="1대1상담">
							</a>
						</div>
						<div class="col-4">
							<a href="#" onclick="loadFaqData();"> <img class="img-fluid"
								src="/images/winct/FAQ_10_1.png" alt="자주듣는질문" href="#">
							</a>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-4">
							<a href="https://www.youtube.com/watch?v=WaWoMowapjI"
								...
								src="/images/winct/YTB_10_1.png" alt="유튜브"
								href="https://www.youtube.com/watch?v=WaWoMowapjI">
							</a>
						</div>
						<div class="col-4">
							<a href="https://blog.naver.com/ewinner7/222973843240"> <img
								class="img-fluid" src="/images/winct/BLG_10_1.png" alt="블로그"
								href="#">
							</a>
						</div>
						<div class="col-4">
							<a href="https://www.instagram.com/"> <img class="img-fluid"
								src="/images/winct/IST_10_1.png" alt="인스타그램" href="#">
							</a>
						</div>
					</div>
				</div>
