...
<script type="text/javascript" src="/js/winct/schcommons.js"></script> <!-- 공통검색 -->
...
<body>
  	<!-- Navbar Start -->
    <div class="container-fluid_act  bg-info mb-2">
        <div class="row px-xl-8">
            <div class="col-lg-3 d-none d-lg-block">
				<a class="btn d-flex justify-content-center align-items-center bg-primary w-85" 
				   data-bs-toggle="collapse" href="#navbar-vertical" 
				   style="height: 50px; padding: 0; width: 100%;"> 
				   <img src="/images/winct/winner_log_han.png" 
				        alt="WinnerNet Logo" 
				        id="consultingTitle" 
				...
				<nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" 
				     id="navbar-vertical" 
				     style="width: 80%; z-index: 999;"> 
				    <div class="nav-item w-100" style="margin-left: 40px;">   <!-- style="text-align: center";> -->
				        <a href="#" class="nav-item nav-link" style="font-size: 16px;" onclick="setActive(this); loadPage('/login/wnnpage_consult1.do')">의료기관 컨설팅</a>
				        <a href="#" class="nav-item nav-link" style="font-size: 16px;" onclick="setActive(this); loadPage('/login/wnnpage_consult2.do')">재청구 컨설팅</a>
				        <a href="#" class="nav-item nav-link" style="font-size: 16px;" onclick="setActive(this); loadPage('/login/wnnpage_consult3.do')">의료기관 인증 컨설팅</a>
				        <a href="#" class="nav-item nav-link" style="font-size: 16px;" onclick="setActive(this); loadPage('/login/wnnpage_consult4.do')">적정성평가 컨설팅</a>
				        <a href="#" class="nav-item nav-link" style="font-size: 16px;" onclick="setActive(this); loadPage('/login/wnnpage_consult5.do')">현지조사 컨설팅</a>
				    </div>
				</nav>
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-info navbar-dark py-3 py-lg-0 px-0">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="#" class="nav-item nav-link">적정성평가 프로그램</a>
                            <a href="#" class="nav-item nav-link">경영분석 프로그렘</a>
                        </div>
            ...
            <div class="col-lg-4">
				...
				<div class="contact-form bg-light box-p-10 mb-3">
				    <form name="loginForm" id="loginForm">
				        ...
				        <div>
				            <button type="button" class="btn btn-block btn-blue text-center font-weight-bold my-2 py-2" id="blogin" onClick="login()">로그인</button>
				        </div>
				        <div class="row">
				            <div class="col-4">
				                <button type="button" class="btn btn-block btn-outline-dark text-center font-weight-bold my-1 py-2" onclick="fnmbrReg();">회원가입</button>
				            </div>
				            <div class="col-4">
				                <button type="button" class="btn btn-block btn-outline-dark text-center font-weight-bold my-1 py-2" onclick="fnPasswdmanager();">ID/PW찾기</button>
				            </div>
				            <div class="col-md-4">
							    <div class="form-check">
							        <input class="form-check-input" type="checkbox" id="saveyn">
							        <span class="font-weight-bold">아이디저장</span>
							    </div>
							</div>
				        </div>
				    </form>
				    <div id="userInfoCard" style="display: none; overflow : auto ; max-height:200px;">
				        <div class="user_card">
...
<style>
	...
	<div class="container-fluid mb-2">
        <div class="row px-xl-8">
            <div class="col-lg-4">
                <div class="bg-light box-p-10" style="height: 200px;">
			        ...
			        <div class="tab-content">
			            <div class="tab-pane fade active show" id="notice-tab">
			                <div class="scroll-table-container" style="max-height: 300px; overflow-x: auto; overflow-y: auto;">
			                    <table id="noticeTable" class="table table-bordered">
							        ...
							        <thead style="height: 30px;">
							            <tr style="height: 30px;">
									        ...
									        <th style="height: 5px;">공지제목</th>
									        <th style="height: 5px;">공지사항</th>
									        <th style="height: 5px;">작성일자</th>
									        <th style="height: 5px;">작성자</th>
									        <th style="height: 5px;">조회수</th>
									    </tr>
									</thead>
			                        <tbody id="noticeArea">
			                            <tr>
			                ...
			                <div class="scroll-table-container" style="max-height: 300px; overflow-x: auto; overflow-y: auto;">
			                    <table id="noticeTable1" class="table table-bordered">
			                        ...
			                        <thead style="height: 30px;">
			                            <tr style="height: 30px;">
			                                <th style="height: 5px;">번호</th>
			                                <th style="height: 5px;">심사제목</th>
			                                <th style="height: 5px;">심사사항</th>
			                                <th style="height: 5px;">작성일자</th>
			                                <th style="height: 5px;">작성자</th>
			                                <th style="height: 5px;">조회수</th>
			                            </tr>
			                ...
			                <div class="scroll-table-container" style="max-height: 300px; overflow-x: auto; overflow-y: auto;">
			                    <table id="noticeTable2" class="table table-bordered">
			                        ...
			                        <thead style="height: 30px;">
			                            <tr style="height: 30px;">
			                                <th style="height: 5px;">번호</th>
			                                <th style="height: 5px;">소식지제목</th>
			                                <th style="height: 5px;">소식지사항</th>
			                                <th style="height: 5px;">작성일자</th>
			                                <th style="height: 5px;">작성자</th>
			                                <th style="height: 5px;">조회수</th>
			                            </tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <a href="#" onclick="fnasq_main();">
                                <img class="img-fluid" src="/images/winct/1-1_10_1.png" alt="1대1상담">
                            </a>
                        </div>
                        <div class="col-4">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <a href="https://www.youtube.com/watch?v=WaWoMowapjI" target="_blank">
                                <img class="img-fluid" src="/images/winct/YTB_10_1.png" alt="유튜브" href="https://www.youtube.com/watch?v=WaWoMowapjI">
                            </a>
                        </div>
                        <div class="col-4">
...
<!--회원가입 모달창   -->
	...
	<div id="mainModal" class="modal fade"  tabindex="-1" data-backdrop="static" role="dialog" aria-hidden="true" data-keyboard="false">
                  ...
                  <div class="modal-header bg-light">
		              ...
		              <div class="form-row">
		                  <div class="col-sm-12 mb-2" style="text-align:right;">          
	                        <button type="submit" class="btn btn-outline-info" onClick ="fnSaveProc('I')">회원가입 <i class="far fa-edit"></i></button>
	   				        <button type="button" class="btn btn-outline-dark" data-dismiss="modal" onClick="mainModalClose()">닫기. <i class="fas fa-times"></i></button>
			              </div>
			          </div>
		         </div>
			<div class="modal-body" style="text-align: left;flex: 1;overflow-y: auto;">	
				<div class="form-container">
    		      <form commandName="DTO" id="memregForm" name="memregForm" method="post">
				    	<input type="hidden" name="iud" id="iud" />
					    <input type="hidden" name="dupchk" id="dupchk" value="X" />
	                    <input type="hidden" name="perUseRed"  id="perUseRed" />	  
	                    <input type="hidden" name="perInfoRed" id="perInfoRed" />	
	                    <input type="hidden" name="perProRed"  id="perProRed" />	  
	                     
	                    <input type="hidden" name="perUseYn"   id="perUseYn" />	  
	                    <input type="hidden" name="perInfoYn"  id="perInfoYn" />	
	                    <input type="hidden" name="perProYn"   id="perProYn" />

	                    <input type="hidden" name="perUseCd"   id="perUseCd" />	  
	                    <input type="hidden" name="perInfoCd"  id="perInfoCd" />	
	                    <input type="hidden" name="perProCd"   id="perProCd" />
	                    <input type="hidden" name="hospUuid"    id="hospUuid" />

						<div class="form-group row g-1 mb-0">
						    <label for="hospCd" class="col-2 col-lg-2 col-form-label text-center">병원코드</label>
						    <div class="col-10 col-sm-10">
						        <div class="input-group">
						            <input id="hospCd" name="hospCd" type="text" class="form-control text-left" placeholder="병원코드를 입력하세요">
						            <button class="btn btn-outline-info ms-auto" id="mstdupid" onclick="fnDupchk()" style="margin-left: 8px;">
						...
						<div class="form-group row g-1 mb-0">
						    <label for="hospNm" class="col-2 col-lg-2 col-form-label text-center">병원명</label>
						    <div class="col-10 col-sm-10">
						        <div class="input-group">
						            <input id="hospNm" name="hospNm" type="text" class="form-control text-left" placeholder="병원명을 입력하세요">
						            <button class="btn btn-outline-info ms-auto" id = "hospserch" style="margin-left: 8px;">
						...
						<div class="form-group row g-1 mb-0">
						    <label for="email" class="col-2 col-lg-2 col-form-label text-center">이메일</label>
						    <div class="col-10 col-sm-10">
						        <div class="input-group">
						            <input id="email" name="email" type="text" class="form-control text-left" placeholder="이메일 주소를 입력하세요" 
						                                            style="flex-grow: 2; min-width: 200px;">
						            <select id="emailList" name="emailList" class="custom-select" onchange="emailcheck()" 
						                                             style="width: 120px; height: 34px; font-size: 14px; margin-left: 8px;">
						...
						<div class="form-group row ">
						    <label for="passWd" class="col-2 col-lg-2 col-form-label text-center">비밀번호</label>
						    <div class="col-4 col-lg-4"> 
  						        <input type="password" id="passWd" name="passWd" class="form-control" placeholder="" >
  						    </div>    
						    <label for="afPassWd" class="col-2 col-lg-2 col-form-label text-center">비밀번호확인</label>
						    <div class="col-4 col-lg-4"> 
  						        <input type="password" id="afPassWd" name="afPassWd" class="form-control" placeholder="" >
  						    </div> 
						</div>
						<!-- 담당자 정보 -->
						<div class="form-group row g-1 mb-2">
						    <label for="mbrNm" class="col-2 col-lg-2 col-form-label text-center">담당자명</label>
							<div class="col-4 col-lg-4"> 
							  <input type="text" id="mbrNm" name="mbrNm" class="form-control" 	placeholder="" >
							</div>  
							<label for="mbrTel" class="col-2 col-lg-2 col-form-label text-center">전화번호</label>
							<div class="col-4 col-lg-4"> 
						  	  <input	type="text" id="mbrTel" name="mbrTel" class="form-control" placeholder="">
							</div> 
						</div>
                        <div class="form-group row g-1 mb-2" style="margin-bottom: 100px">
                        </div>
						<div class="form-group row g-1 mb-2"> <!-- 간격을 늘리기 위한 margin-bottom 추가 -->
						    <div class="checkbox-group w-100" style="margin-left: 250px;">
						        <div class="input-group d-flex align-items-center">
						            <input type="checkbox" id="allAgree" onclick="toggleAllAgreement()" class="mr-2">
						            <span for="allAgree" class="mb-0 ml-2">모두동의 합니다</span>
						        </div>
						
						        <div class="input-group d-flex align-items-center justify-content-between">
						            <div class="d-flex align-items-center">
						                <input type="checkbox" id="peruseyn" name="peruseyn" onchange="checkAction()" class="mr-2">
						                <span for="peruseyn" class="mb-0 ml-2">이용약관 동의</span>
						            </div>
						            <button type="button" class="btn btn-outline-dark btn-sm mr-4" onclick="openModal('이용약관 동의','PER_USE_CD')">세부확인</button>
						        </div>
						
						        <div class="input-group d-flex align-items-center justify-content-between">
						            <div class="d-flex align-items-center">
						                <input type="checkbox" id="perinfoyn" name="perinfoyn" onchange="checkAction()" class="mr-2">
						                <span for="perinfoyn" class="mb-0 ml-2">개인정보 수집 및 이용 동의</span>
						            </div>
						            <button type="button" class="btn btn-outline-dark btn-sm mr-4" onclick="openModal('개인정보 수집 및 이용 동의','PER_INFO_CD')">세부확인</button>
						        </div>
						
						        <div class="input-group d-flex align-items-center justify-content-between">
						            <div class="d-flex align-items-center">
						                <input type="checkbox" id="perproyn" name="perproyn" onchange="checkAction()" class="mr-2">
						                <span for="perproyn" class="mb-0 ml-2">개인정보 처리위탁 동의</span>
						            </div>
						            <button type="button" class="btn btn-outline-dark btn-sm mr-4" onclick="openModal('개인정보 처리위탁 동의','PER_PRO_CD')">세부확인</button>
						        </div>
						    </div>
						</div>
			    	  </form>
	...
	<!-- Modal 동의서 확인 -->
	<div id="termsModal" class="modal fade" data-backdrop="static" data-keyboard="false"  tabindex="-1" role="dialog" aria-hidden="true">
	    <div class="modal-dialog modal-lg" style="max-width: 800px;">
		    <div class="modal-content" style="height: 70%; display: flex; flex-direction: column; position: relative;">
		        <div class="modal-header">
			        <div style="text-align: center; font-size: 18px; padding-left: 250px; color: black;">
		        ...
		        <div  style="flex-grow: 1; overflow-y: auto; display: flex; justify-content: center; align-items: center;">
		            <sapn for=""  style="right"></sapn>
	                    <input type="hidden" name="codeCd" id="codeCd" />	            
		                <textarea class="form-control" aria-label="With textarea" 
		                          name="subCodeNm" id="subCodeNm" style="width: 100%; height: 90%; font-size: 14px;"></textarea>
	            </div>
	            <div style="text-align: center; padding: 10px;">
					 <button class="btn btn-primary btn-sm" onclick="confirmAction()" 
					        style="width: 100%; padding: 10px 20px; font-size: 14px; cursor: pointer; 
					        box-sizing: border-box; background-color: transparent; border: 1px solid black; color: inherit;">
					    확인
					</button>
                </div>
	        </div>
...
<!-- 회원가입 스크립트 시작 -->
	<script>	
	        ...
	        function checkAction() {
	        	$("#perUseYn").val($("#peruseyn").prop("checked") ? "Y" : "N");
	            $("#perInfoYn").val($("#perinfoyn").prop("checked") ? "Y" : "N");
	            $("#perProYn").val($("#perproyn").prop("checked") ? "Y" : "N");
	        }
...
<!--아이디찾기  -->
	...
	<div class="modal fade" id="passserachModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
	        ...
	        <div class="modal-content rounded-3 shadow-lg">
                <form:form commandName="DTO" id="pwserchregForm" name="pwregForm" method="post">
                    ...
                    <div class="pass-box w-70">    
                        ...
                        <h11 style="font-size: 12px; color: #555;">
                            아이디를 찾기 위해서 성명 및 이메일를 등록하고 아이디찾기를 실행하세요
                        </h11>
                ...
                <div class="set-btn-box w-100 mt-3 text-right">
                    ...
                    <button type="button" class="btn btn-primary" onclick="fnPasswdreset();">초기화/변경</button> <!--  원래는 팝업 fnPwdClear()  -->
                </div>
            </div> 
        </div>
    </div>
...
<!-- 비빌번호 초기화 변경  -->	
    ...
    <div class="modal fade" id="pwresetForm" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true" style="margin-left: -1px;">
	   <div class="modal-dialog modal-lg" style="max-width: 500px;">
	     <div class="modal-content rounded-3 shadow-lg">
	       <form:form commandName="DTO" id="pwresetregForm" name="pwresetregForm" method="post">
	        <h4>비밀번호 초기화 변경</h4>
	        <div class="pass-box w-70">                                              
	          <input type="text" name="hospCd1" class="form-control mt-2" id="hospCd1"  value="" placeholder="요양기관기호"/>
			  <input type="text" name="userId1" class="form-control mt-2" id="userId1"  value="" placeholder="사용자ID"/>
			          <h11 style="font-size: 12px; color: #555;">비밀번호 초기화시에는 요양기관과 사용자ID만 입력하고 초기화하세요</h11>    
	          <input type="password" class="form-control mt-2" id="passWd1" name="passWd1" placeholder="현재 비밀번호">
	          <input type="password" class="form-control mt-2" id="bfPassWd1" name="bfPassWd1"  placeholder="변경 비밀번호">
	          <input type="password" class="form-control mt-2" id="afPpassWd1" name="afPassWd1"  placeholder="변경 비밀번호 확인">
	        </div>
			</form:form>
				<div class="set-btn-box w-100 mt-3 d-flex justify-content-between">
				    <div>
				    	<button type="button" class="btn btn-primary" onclick="fnSaveReset();">비밀번호초기화</button>
				    </div>
				    <div>
				        <button type="button" class="btn btn-outline-dark" onclick="fnPasswdresetClose();">취소</button>
...
<!-- 공지사항 모달 -->
	<div id="adminModal" class="modal fade" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
	  <div class="modal-dialog modal-lg" style="max-width: 800px;">
	    <div class="modal-content" style="height: 80%; display: flex; flex-direction: column; position: relative; 
	                                    border-radius: 10px; box-shadow: 0px 4px 20px rgba(0, 0, 0, 0.1);">
	      ...
	      <form:form commandName="DTO" id="regForm" name="regForm" method="post" enctype="multipart/form-data" 
	        ...
	        <div class="modal-body" style="overflow-y: auto; padding: 20px;">
				<div class="mb-0">
				    <label for="notiTitle" class="form-label fw-bold" style="font-size: 14px !important; display: block; text-align: left;">제목</label> 
				    <input type="text" name="notiTitle" id="notiTitle" class="form-control" placeholder="제목을 입력하세요.">
				</div>
				
				<div class="mb-0">
				    <label for="notiTitle" class="form-label fw-bold" style="font-size: 14px !important; display: block; text-align: left;">내용</label> 
				    <textarea class="form-control" name="notiContent" id="notiContent" rows="12" placeholder="내용을 입력하세요." 
		   	...
		   	success : function(data) {
		   		...
		   		if(data.resultCnt > 0 ){
		    		...
		    		for(var i=0 ; i < data.resultCnt; i++){
					  ...
					  $(targetArea).append("<tr><td colspan='6'>검색된 정보가 없습니다.</td></tr>");
				  }
		      }
	   });
	}   
...
<script>
	...
	<!-- 기존 1대1 질의응답  -->
	<div class="modal fade" id="asq_main_tab" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
	    <div class="modal-dialog modal-lg" style="max-width: 900px; width: 90%;">
	        <!-- 모달 전체 높이를 100vh에서 auto로 변경하고 최대 높이를 제한 -->
	        <div class="modal-content shadow-lg rounded-4" style="height: auto; max-height: 90vh; border: none;">
	            <div class="modal-header bg-light" style="height: 35px; padding: 5px 10px;">
	            ...
	            <div class="modal-body bg-light" style="max-height: 60vh; overflow-y: auto;"> 
	                <div class="d-flex align-items-center justify-content-between mb-3">
	                    <div class="d-flex">
	                        <input type="text" id="searchText" class="form-control rounded-3 border" 
	                               placeholder="검색어를 입력하세요."  onkeypress="if(event.keyCode == 13){fnasq_Search();}" style="width: 300px;">
	                        <button type="button" class="btn btn-warning rounded-3 ms-2" onclick="fnasq_Search()" style="margin-left: 8px;">
	                ...
	                <div class="table-responsive rounded-3 shadow-sm mt-1 border" style="height: 500px; overflow-y: auto;">
	                    <table id="asq_infoTable" class="table table-bordered">
							<colgroup>
							    <col style="width: 50px">
							    <col style="width: 150px">
							    <col style="width: 160px"> <!-- 질문제목 너비 줄임 -->
							    <col style="width: 160px"> <!-- 질문내용 너비 줄임 -->
	            ...
	            <div class="modal-footer" style="background-color: white; padding: 5px 10px;">
	                <!-- 필요한 footer 내용 추가 -->
	            </div>
	        </div>
	    </div>
...
<!--질문응답-->
	<div class="modal fade" id="asq_main" tabindex="-1" data-bs-backdrop="static" data-keyboard="false" aria-hidden="true">
	    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
	         style="position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); width:45vw; max-width:45vw; max-height: 50vh;">
	        <div class="modal-content" style="height: 72%; display: flex; flex-direction: column;">
                <div class="modal-header  bg-light">
                   <h6 class="modal-title">문의 등록</h6>
                    <div class="form-row">
                        <div class="col-sm-12 mb-2" style="text-align:right;">
                          <button type="button" id = "save_btn"  type="submit" class="btn btn-outline-info"    onClick="fnasq_SaveProc()">저장. <i class="far fa-edit"></i></button>
                          <button type="button" class="btn btn-outline-dark" data-dismiss="modal" onClick="asqModalClose()">닫기 <i class="fas fa-times"></i></button>
                        </div> 
                     </div>
                </div>
	            <form:form commandName="DTO"  id="asq_regForm" name="asq_regForm" method="post" enctype="multipart/form-data">
	                ...
	                <!-- Spring Form 태그 사용 (Spring MVC 환경이라면 적용 가능) -->
	                    ...
	                    <div class="form-group ">
	                        ...
	                        <div class="col-10 col-lg-10">   
	                            <input id="qstnTitle" name="qstnTitle" type="text" class="form-control" placeholder="질문제목을 입력하세요">
	                        </div>
	                    </div>
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-10 col-lg-10"> 
	                            <textarea id="qstnConts" name="qstnConts" placeholder="질문내용을 입력하세요"
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-4 col-lg-4">
	                            <select id="qstnWan" name="qstnWan" class="custom-select" style="height:35px; font-size:14px;">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-10 col-lg-10">
	                            <textarea id="ansrConts" name="ansrConts" placeholder="답변내용 입력하세요"
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-4 col-lg-4">
	                            <select id="ansrWan" name="ansrWan" class="custom-select" style="height:35px; font-size:14px;">
	                                <option value="">선택</option> 
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn btn-outline-dark" data-dismiss="modal" 
                        onclick="faqMainClose()">닫기 <i class="fas fa-times"></i></button>
            </div>
