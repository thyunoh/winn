...
<!-- Navbar End -->
	   ...
	   <div id="contentArea"></div>
		      ...
		      <div class="contact-form box-p-10 mb-3 w-100"
		        ...
		        <form name="loginForm" id="loginForm">
		          <div class="row g-0 align-items-start justify-content-between">
		            <!-- 입력 필드 영역 -->
		            <div class="col-md-7 px-3" style="margin-left: 35px;">
		              <hr style="border: none; border-top: 2px solid #aaa; margin: 2px 0; width: 0.8cm;">
		              <h6 class="section-title position-relative mb-2 text-white">
		                <span style="font-size: 1.2em;">로그인 <small style="font-size: 0.80em; color: white;">LOGIN</small></span>
		              </h6>
		              <div class="mb-2">
		            ...
		            <!-- 로그인 버튼 + 링크 -->
		            <div class="col-md-4 text-center d-flex flex-column align-items-center justify-content-center" style="margin-top: 34px;">
		              ...
		              <div class="mt-2 text-white" style="font-size: 13px; font-weight: bold;">
		              ...
		              <div style="position: relative; display: flex; align-items: center; font-size: 1.25rem; margin-top: -2vh;">
		                <div style="display: flex; align-items: center;">
		                  <h3 id="hosp_name" class="user_card-text"
		                      style="font-size: 20px; border-bottom: 2px solid #000; margin-top: 16px; margin-left: -20px; padding-bottom: 2px;"></h3>
		        ...
		        <div class="image-layout" style="display: flex; justify-content: space-between; align-items: flex-start;">
		          ...
		          <div style="flex-basis: 65%; max-width: 65%; padding-right: 20px; margin-top: -30px;">
		            ...
		            <div style="text-align: left;">
		              <span style="font-size: 14px; font-weight: bold;">데이터 기반으로 맞춤 솔루션</span>
		            </div>
        ...
        <!--  공지사항   -->
		<div class="container-fluid mb-2 px-3"  style = "transform: translateX(10px);">
			...
			<div class="col-lg-4">
              <div class="helpdesk">
				<div class="bg-light box-p-10" style="width: 635px; height: 60px; margin-top: 0px; margin-left: -12px; position: relative; left: 20px;">
