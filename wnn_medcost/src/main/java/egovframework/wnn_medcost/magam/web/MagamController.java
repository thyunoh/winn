...
public class MagamController {
	...
	public Map<String, Object> select_Hosp_Indi(@RequestParam("hosp_cd") List<String> hospCds,
											    ...
											    @RequestParam(value = "month_1", required = false, defaultValue = "") String m1,
											    @RequestParam(value = "month_2", required = false, defaultValue = "") String m2,
											    @RequestParam(value = "month_3", required = false, defaultValue = "") String m3,
											    @RequestParam(value = "month_4", required = false, defaultValue = "") String m4,
											    @RequestParam(value = "month_5", required = false, defaultValue = "") String m5,
											    @RequestParam(value = "month_6", required = false, defaultValue = "") String m6,
											    HttpSession session,
