...
<link href="/css/winmc/style_comm.css?v=123"  rel="stylesheet">
    ...
    <style>
	                            ...
	                            <div class="form-row mb-2">
                                    ...
                                    <div class="col-sm-6">                                    
                                         <div class="btn-group ml-auto">
                                            ...
                                            <button class="btn btn-outline-dark" data-toggle="tooltip" data-placement="top" title="선택 Data 수정" onClick="modal_Open('U')">상세조회. <i class="far fa-save"></i></button>                                            
	          ...
	          <div class="modal-body" style="text-align: left;flex: 1;overflow-y: auto;">	          
                ...
                <div id="inputZone">                
                    ...
                    <div class="form-group row ">
	                   ...
	                   <label for="kyeGu" class="col-2 col-lg-2 col-form-label text-left">급여기준</label>
	                   <div class="col-2 col-lg-2">                                       
	                      <input id="kyeGu" name="kyeGu" type="text" class="form-control" placeholder="">
	                   </div>
                    </div>
                    ...
                    <div class="form-group row">
                       <label for="hosPrice" class="col-2 col-sm-2 col-form-label text-right">상한가</label>
                       <div class="col-4 col-lg-4">  
                            <input id="hosPrice" name="hosPrice" type="number" class="form-control" style="text-align: right;" placeholder="">
                       </div>
                       <label for="gaPrice" class="col-2 col-sm-2 col-form-label text-right">가산금</label>
                       <div class="col-4 col-lg-4">  
                            <input id="gaPrice" name="gaPrice" type="number" class="form-control"  style="text-align: right;"  placeholder="">
                       </div>
                    </div>
                    <div class="form-group row g-0 mb-0">
                        <label for="bokPath" class="col-2 col-sm-2 col-form-label text-left">투여경로</label>
                        <div class="col-2 col-sm-2">
                            <input id="bokPath" name="bokPath" type="text" class="form-control" placeholder="">
                        </div>
                        <label for="std" class="col-2 col-sm-2 col-form-label text-left">규격</label>
                        <div class="col-2 col-sm-2">
                            <input id="std" name="std" type="text" class="form-control" placeholder="">
                        </div>
                        <label for="unit" class="col-2 col-sm-2 col-form-label text-left">단위</label>
                        <div class="col-2 col-sm-2">
                            <input id="unit" name="unit" type="text" class="form-control" placeholder="">
                        </div>
                    </div>
  
                    <div class="form-group row ">
                        <label for="upso" class="col-2 col-sm-2 col-form-label text-left">업소</label>
                        <div class="col-10 col-sm-10">
                            <input id="upso" name="upso" type="text" class="form-control is-invalid text-left" placeholder="">
                        </div>
                    </div>                  

                    <div class="form-group row">
                        <label for="bunCd" class="col-2 col-lg-2 col-form-label text-left">분류번호</label>
                        <div class="col-2 col-lg-2">
                            <input id="bunCd" name="bunCd" type="text"  class="form-control"  placeholder="">
                        </div>
                        <label for="sungCd" class="col-2 col-lg-2 col-form-label text-left">주성분코드</label>
                        <div class="col-2 col-lg-2">
                            <input id="sungCd" name="sungCd"  type="text" class="form-control" placeholder="">
                        </div>
                        <label for="medGu" class="col-2 col-lg-2 col-form-label text-left">전문/일반</label>
                        <div class="col-2 col-lg-2">
                            <input id="medGu" name="medGu"  type="text" class="form-control" placeholder="">
                        </div>
                    </div>
                     <div class="form-group row">
                        <label for="tejangRea" class="col-2 col-lg-2 col-form-label text-left">퇴장방지</label>
                        <div class="col-2 col-lg-2">
                            <input id="tejangRea" name="tejangRea" type="text" class="form-control" placeholder="">
                        </div>
                        <label for="medLevel" class="col-2 col-lg-2 col-form-label text-left">의약품동등성</label>
                        <div class="col-2 col-lg-2">
                            <input id="medLevel" name="medLevel"  type="text" class="form-control"  placeholder="">
                            
                        </div>
                        <label for="lowYn" class="col-2 col-lg-2 col-form-label text-left">저가대체가산여부</label>
                        <div class="col-2 col-lg-2">
                            <input id="lowYn" name="lowYn"  type="text" class="form-control"  placeholder="">
                            
                        </div>
  
	 		        </div>    
                    <div class="form-group row">
		                  <label for="etcMed" class="col-2 col-lg-2 col-form-label text-left">예외의약품구분</label>
		                  <div class="col-2 col-lg-2">
		                      <input id="etcMed" name="etcMed" type="text" class="form-control"  placeholder="">
		                  </div>
		                  <label for="optMedYn" class="col-2 col-lg-2 col-form-label text-left">임의조제불가항목</label>
		                  <div class="col-2 col-lg-2">
		                      <input id="optMedYn" name="optMedYn" type="text" class="form-control"  placeholder="">
		                  </div>
		                  <label for="medRegDt" class="col-2 col-lg-2 col-form-label text-left">고시일자</label>
		                  <div class="col-2 col-lg-2">
		                      <input id="medRegDt" name="medRegDt" type="text" class="form-control"  placeholder="">
		                  </div>
                    </div>    
                    <div class="form-group row">
                        <label for="copay30" class="col-2 col-lg-2 col-form-label text-left">본인부담률30</label>
                        <div class="col-2 col-lg-2">
                            <input id="copay30" name="copay30" type="text"  class="form-control"  placeholder="">
                        </div>
                        <label for="copay80" class="col-2 col-lg-2 col-form-label text-left">본인부담률50</label>
                        <div class="col-2 col-lg-2">
                            <input id="copay50" name="copay50"  type="text" class="form-control" placeholder="">
                        </div>
                        <label for="copay90" class="col-2 col-lg-2 col-form-label text-left">본인부담률80</label>
                        <div class="col-2 col-lg-2">
                            <input id="copay80" name="copay80"  type="text" class="form-control" placeholder="">
                        </div>
                    </div>
                <!-- ============================================================== -->
                <!-- end form 수정해야 될 곳 -->
		...
		findValues.push({ id: "findData",  val: "타이레놀",  chk: true  });
		//Form마다 조회 조건 변경 종료
		...
		<!-- 공통코드 Setting End -->
		<!-- ============================================================== -->
		var format_convert = ['startDt'] ; //날자에서 '-' '/' 제외설정   
		...
		var c_Head_Set = [
						    { name: '약가코드', className: 'dt-body-center' },
						    { name: '시작일자', className: 'dt-body-center' },
						    { name: '품명',    className: 'dt-body-center' },
						    { name: '급여기준', className: 'dt-body-center' },
						    { name: '상한가',  className: 'dt-body-center' },
						    { name: '가산금',  className: 'dt-body-center' },
						    { name: '투여경로', className: 'dt-body-center' },
						    { name: '규격',   className: 'dt-body-center' },
						    { name: '단위',   className: 'dt-body-center' },
						    { name: '업소',   className: 'dt-body-center' },
						    { name: '성분코드',   className: 'dt-body-center' }
						];
		var columnsSet = [  // data 컬럼 id는 반드시 DTO의 컬럼,Modal id는 일치해야 함 (조회시)
	        				...
	        				{ data: 'kyeGu',      visible: true,  className: 'dt-body-center', width: '100px',  },
	        				{ data: 'hosPrice',   visible: true,  className: 'dt-body-right',  width: '100px',  },
	        				{ data: 'gaPrice',    visible: true,  className: 'dt-body-right' , width: '100px',  },	        				
					        { data: 'bokPath' ,   visible: true,  className: 'dt-body-center',  width: '100px',  },
					        { data: 'std' ,       visible: true,  className: 'dt-body-center',  width: '100px',  },
					        { data: 'unit'   ,    visible: true,  className: 'dt-body-center' , width: '100px',  },
					        { data: 'upso'   ,    visible: true,  className: 'dt-body-center' , width: '100px',  },
					        { data: 'sungCd'  ,   visible: true,  className: 'dt-body-center' , width: '100px',  }
						 ];
		...
		function validateForm() {
		    const results = formValCheck(inputZone.id, {
		        feeCode:  { kname: "약가코드", k_min: 3, k_max: 10, k_req: true, k_spc: true, k_clr: true },
		        startDt:  { kname: "시작일자", k_req: true },
		        kyeGu:    { kname: "급비기준", k_req: true },
		        hosPrice: { kname: "상한가", k_req: true },
		        gaPrice:  { kname: "가산금", k_req: true },
		        bokPath:  { kname: "투여경료", k_req: true },
		        korNm:    { kname: "품명", k_req: true },
		        std:      { kname: "규격", k_num: true },
		        unit:     { kname: "단위", k_num: true },
		        upso:     { kname: "업소", k_num: true },
		        bunCd:    { kname: "분류번호", k_num: true }
		    });
		    return results;
		}
		//그리드상 데이타생성및 수정 작업
