...
<link href="/css/winmc/style_comm.css?v=123" rel="stylesheet">
    ...
    <style>
	          ...
	          <div class="modal-body" style="text-align: left;flex: 1;overflow-y: auto;">	          
                ...
                <div id="inputZone">                
                    ...
                    <div class="form-group row ">
	                   ...
	                   <label for="firstDt" class="col-2 col-lg-2 col-form-label text-left">최초등재일</label>
	                   <div class="col-2 col-lg-2">                                       
	                      <input id="firstDt" name="firstDt" type="text" class="form-control date1-inputmask" placeholder="yyyy-mm-dd" maxlength="">
	                   </div>
                    </div>
                    ...
                    <div class="form-group row">
                       <label for="hospPrice" class="col-2 col-sm-2 col-form-label text-right">상한금액</label>
                       <div class="col-2 col-lg-2">  
                            <input id="hospPrice" name="hospPrice" type="number" class="form-control" style="text-align: right;" placeholder="">
                       </div>
                       <label for="std" class="col-2 col-sm-2 col-form-label text-right">규격</label>
                       <div class="col-2 col-lg-2">  
                            <input id="std" name="std" type="text" class="form-control" placeholder="">
                       </div>
                        <label for="unit" class="col-2 col-sm-2 col-form-label text-right">단위</label>
                       <div class="col-2 col-lg-2">  
                            <input id="unit" name="unit" type="text" class="form-control" placeholder="">
                       </div>
                    </div>
                    <div class="form-group row g-0 mb-0">
                        <label for="companyNm" class="col-2 col-sm-2 col-form-label text-left">제조회사</label>
                        <div class="col-6 col-sm-6">
                            <input id="companyNm" name="companyNm" type="text" class="form-control" placeholder="">
                        </div>
                        <label for="jaejil" class="col-2 col-sm-2 col-form-label text-left">재질</label>
                        <div class="col-2 col-sm-2">
                            <input id="jaejil" name="jaejil" type="text" class="form-control" placeholder="">
                        </div>
                    </div>
  
                    <div class="form-group row ">
                        <label for="impUpso" class="col-2 col-sm-2 col-form-label text-left">제조·수입업소</label>
                        <div class="col-10 col-sm-10">
                            <input id="impUpso" name="impUpso" type="text" class="form-control is-invalid text-left" placeholder="">
                        </div>
                    </div>                  

                    <div class="form-group row">
                        <label for="copay50" class="col-2 col-lg-2 col-form-label text-left">본인부담률50</label>
                        <div class="col-2 col-lg-2">
                            <input id="copay50" name="copay50" type="text"  class="form-control"  placeholder="">
                        </div>
                        <label for="copay80" class="col-2 col-lg-2 col-form-label text-left">본인부담률80</label>
                        <div class="col-2 col-lg-2">
                            <input id="copay80" name="copay80"  type="text" class="form-control" placeholder="">
                        </div>
                        <label for="copay90" class="col-2 col-lg-2 col-form-label text-left">본인부담률90</label>
                        <div class="col-2 col-lg-2">
                            <input id="copay90" name="copay90"  type="text" class="form-control" placeholder="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="dupYn" class="col-2 col-lg-2 col-form-label text-left">중복인정여부</label>
                        <div class="col-4 col-lg-4">
                            <input id="dupYn" name="dupYn" type="text"  class="form-control"  placeholder="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="remark" class="col-2 col-lg-2 col-form-label text-left">비고</label>
		...
		findValues.push({ id: "findData",  val: "NYLON",  chk: true  });
		//Form마다 조회 조건 변경 종료
		...
		var c_Head_Set = [
						    { name: '재료대코드',  className: 'dt-body-center' },
						    { name: '시작일자',   className: 'dt-body-center' },
						    { name: '품명',      className: 'dt-body-center' },
						    { name: '종료일자',   className: 'dt-body-center' },
						    { name: '중분류',     className: 'dt-body-center' },
						    { name: '중분류코드',  className: 'dt-body-center' },
						    { name: '규격',      className: 'dt-body-center' },
						    { name: '단위',       className: 'dt-body-center' },
						    { name: '상한금액',    className: 'dt-body-center' },
						    { name: '제조회사',    className: 'dt-body-center' },
						    { name: '제조·수입업소', className: 'dt-body-center' }
						];
		var columnsSet = [  // data 컬럼 id는 반드시 DTO의 컬럼,Modal id는 일치해야 함 (조회시)
	        				...
	        				{ data: 'midBunru',      visible: true,  className: 'dt-body-center', width: '100px',  },
	        				{ data: 'midCode',       visible: true,  className: 'dt-body-right',  width: '100px',  },
	        				{ data: 'std',           visible: true,  className: 'dt-body-right' , width: '100px',  },	        				
					        { data: 'unit' ,         visible: true,  className: 'dt-body-center',  width: '100px',  },
					        { data: 'hospPrice' ,    visible: true,  className: 'dt-body-center',  width: '100px',  },
					        { data: 'companyNm' ,    visible: true,  className: 'dt-body-center' , width: '200px',  },
					        { data: 'impUpso'   ,    visible: true,  className: 'dt-body-center' , width: '100px',  }
						 ];
		...
		var markColums = ['korNm','companyNm'];
