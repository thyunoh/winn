...
<div class="qh-wrap">
  <div class="qh-head"><div class="qh-title"><span class="qh-dot"></span>QPS(질향상·환자안전) 사용 안내</div></div>
  <p class="qh-lede">
  ...
  <section id="h1">
    ...
    <p>지표 화면 상단 오른쪽의 <b>년도</b>를 바꾸면 그 해 자료로 전환됩니다. 화면 머리의
      <b>🏥 병원 배지</b>는 지금 조회·입력되는 병원입니다 — 입력 전에 반드시 확인하세요.</p>
    <div class="qh-warn">⚠ 여러 병원을 관리하는 계정(위너넷)은 상단 [병원검색]으로 대상 병원을 먼저 고르세요.
      병원을 바꾸지 않고 입력하면 다른 병원 자료로 저장됩니다.</div>
  </section>
  ...
  <section id="h8">
    ...
    <table>
      ...
      <tr><td>입력했는데 자료가 안 보인다</td>
          <td>화면 머리의 <b>병원 배지</b>와 <b>년도</b>를 확인하세요 — 다른 병원·다른 해를 보고 있는 경우가 대부분입니다.</td></tr>
