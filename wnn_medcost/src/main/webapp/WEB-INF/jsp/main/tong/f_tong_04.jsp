...
<body>
  <div class="container">
	...
	<table id="dataTable" border="1" cellspacing="0" cellpadding="1" style="border-collapse: collapse; text-align: center;">
	  <thead>
	    <tr>
	      <th rowspan="2" style="width: 60px;">진단코드</th>
	      <th rowspan="2" style="width: 150px;">진단영</th>
	      <th colspan="7">분류내용</th>
	    </tr>
	    <tr>
	      <th style="width: 100px;">청구액</th>
	      <th style="width: 60px;">건수</th>
	      <th style="width: 60px;">인당건수</th>
	      <th style="width: 100px;">건당금액</th>
	      <th style="width: 100px;">인당금액</th>
	      <th style="width: 60px;">건당(%)</th>
	      <th style="width: 60px;">인당(%)</th>
	    </tr>
	  </thead>
	  <tbody id="tableBody">
   	 </tbody>
	    ...
	    success: function(data) {
		      ...
		      data.forEach(item => {
		    	 const row = [
		          ...
		          numberWithCommas(item.uniqPatients),
		          numberWithCommas(item.amtPerClaim),
                  numberWithCommas(item.amtPerPatient),
		          numberWithCommas(item.rateOfTotalAmt),
		          numberWithCommas(item.rateOfClaims)
		          ];
		        tableData.push({ row });
		      });
