...
<style>
		...
		<div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                <div class="row">
	                            ...
	                            <div class="form-row mb-2">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                             ...
                                             <div class="input-group-append">
                                                 <button type="button" class="btn btn-rounded btn-primary"  onClick="fn_FindData()">조회. </button>
                                             </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">                                    
                                         <div class="btn-group ml-auto">
                                            <button class="btn btn-outline-light" data-toggle="tooltip" data-placement="top" title=""            onClick="fn_re_load()">재조회. <i class="fas fa-binoculars"></i></button>
                                            <button class="btn btn-outline-light" data-toggle="tooltip" data-placement="top" title="신규 Data 입력" onClick="modal_Open('I')">입력. <i class="far fa-edit"></i></button>                                            
                                            <button class="btn btn-outline-light" data-toggle="tooltip" data-placement="top" title="선택 Data 수정" onClick="modal_Open('U')">수정. <i class="far fa-save"></i></button>                                            
                                            <button class="btn btn-outline-light" data-toggle="tooltip" data-placement="top" title="선택 Data 삭제" onClick="modal_Open('D')">삭제. <i class="far fa-trash-alt"></i></button>                                             
                    ...
                    <!-- basic form start -->
                    <!-- ============================================================== -->                    
                    <div id="basicFormAll" class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                        <div class="card">
                        	<br>
	    ...
	    <div class="modal fade" id="modalName" tabindex="-1" data-backdrop="static" role="dialog" aria-hidden="false" data-keyboard="false">
	      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"   role="dialog" style="position:absolute; top:50%; left:50%; 
	                                                   transform:translate(-50%, -50%); width:50vw; max-width:50vw;max-height: 80vh;margin: 0;">
	          ...
	          <div class="modal-body" style="text-align: left;flex: 1;overflow-y: auto;">	          
                ...
                <div id="inputZone">                
                    ...
                    <div class="form-group row">
                        <label for="input1" class="col-1 col-sm-1 col-form-label text-left">수가코드</label>
                        <div class="col-11 col-sm-11">
                            <input id="fee_code" name="input1" type="text" class="form-control is-invalid text-left" required placeholder="입력하세요 1">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="input2" class="col-1 col-sm-1 col-form-label text-left">한글명</label>
                        <div class="col-11 col-sm-11">
                    ...
                    <div class="form-group row">
                        <label for="input3" class="col-1 col-sm-1 col-form-label text-left">영문명</label>
                        <div class="col-11 col-sm-11">
                    ...
                    <div class="form-group row">
                        <div class="col-xl-4 col-lg-4 mb-2 text-left">
		                    <label for="mask1">시작일자 <small class="text-muted"> yyyy-mm-dd</small></label>	                                        
		                    <input id="start_dt" name="mask1" type="text" class="form-control date1-inputmask" placeholder="yyyy-mm-dd" maxlength="">
		                </div>
                        <div class="col-xl-4 col-lg-4 mb-2 text-left">
		                    <label for="mask1">종료일자 <small class="text-muted"> yyyy-mm-dd</small></label>	                                        
		                    <input id="end_dt" name="mask1" type="text" class="form-control date1-inputmask" placeholder="yyyy-mm-dd" maxlength="">
		                </div>		                
                    </div>
		...
		var c_Head_Set = [  '수가코드','구분','구분명','한글명','영문명','시작일','종료일','상대점수' ,'병원단가','산정명칭'  ];
		var columnsSet = [  // data 컬럼 id는 반드시 DTO의 컬럼,Modal id는 일치해야 함 (조회시)
					        ...
					        { data: 'rlt_value' , visible: true, className: 'dt-body-center', width: '100px',  },
					        { data: 'hos_price' , visible: true, className: 'dt-body-center', width: '100px',  },
					        { data: 'calc_nm'   , visible: true, className: 'dt-body-left'  , width: '300px',  }
						 ];
		...
		window.onload = function() {
			document.getElementById("basicFormAll").style.display = "none";
			find_Check();
			comm_Check();
