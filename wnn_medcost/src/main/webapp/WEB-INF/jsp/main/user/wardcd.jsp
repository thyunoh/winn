...
<link href="/css/winmc/style_comm.css?v=123"  rel="stylesheet">
    ...
    <style>
	          ...
	          <div class="modal-body" style="text-align: left;flex: 1;overflow-y: auto;">	          
                ...
                <div id="inputZone">                
                    ...
                    <div class="form-group row ">
                       ...
                       <div class="col-4 col-lg-4">  
						  <input id="startYm" name="startYm" type="text" class="form-control text-left" required placeholder="적용년월를 입력하세요">
	                   </div>
	                </div>
	                <div class="form-group row ">   
                       <label for="wardCnt" class="col-2 col-lg-2 col-form-label text-left">입원병상수</label>
                       <div class="col-4 col-lg-4">  
						  <input id="wardCnt" name="wardCnt" type="text" class="form-control text-left" required placeholder="입원병상수를 입력하세요">
	                   </div>
                       <label for="icuCnt" class="col-2 col-lg-2 col-form-label text-left">중환자병상수</label>
                       <div class="col-4 col-lg-4">  
						  <input id="icuCnt" name="icuCnt" type="text" class="form-control text-left" placeholder="중환자병상수를 입력하세요">
	                   </div>
                    </div>
                    <div class="form-group row g-0 mb-0">
                       <label for="erCnt" class="col-2 col-lg-2 col-form-label text-left">응급실병상수</label>
                       <div class="col-4 col-lg-4">  
						  <input id="erCnt" name="erCnt" type="text" class="form-control text-left" placeholder="응급실병상수를 입력하세요">
	                   </div>
                       <label for="isolCnt" class="col-2 col-lg-2 col-form-label text-left">격리실병상수</label>
                       <div class="col-4 col-lg-4">  
						  <input id="isolCnt" name="isolCnt" type="text" class="form-control text-left" placeholder="격리실병상수를 입력하세요">
	                   </div>
	                </div>   
	                <div class="form-group row g-0 mb-0">
                       <label for="docCnt" class="col-2 col-lg-2 col-form-label text-left">전문의수</label>
                       <div class="col-4 col-lg-4">  
						  <input id="docCnt" name="docCnt" type="text" class="form-control text-left" placeholder="전문의수를 입력하세요">
	                   </div>
                        <label for="useYn" class="col-2 col-lg-2 col-form-label text-left">사용구분</label>
	  ...
	  //원너넷이 아니거나 워너넷에서 병원을 선택해서 처리한 경우) //병원병원에서 접속시 요양기관 값셋팅
		...
		<!-- 공통코드 Setting End -->
		<!-- ============================================================== -->
		var format_convert = ['startDt','endDt','startYm'] ; //날자에서 '-' '/' 제외설정   
		...
		var c_Head_Set = ['병원정보','병원명','적용년월','병상수','중환자수','응급실수','격리실수','전문의수','사용여부','등록일'];
		var columnsSet = [  // data 컬럼 id는 반드시 DTO의 컬럼,Modal id는 일치해야 함 (조회시)
	        				...
	        				{ data: 'wardCnt',   visible: true,  className: 'dt-body-center', width: '50px',   },
	         				{ data: 'icuCnt',    visible: true,  className: 'dt-body-center', width: '50px',   },
	         				{ data: 'erCnt',     visible: true,  className: 'dt-body-center', width: '50px',   },
	         				{ data: 'isolCnt',   visible: true,  className: 'dt-body-center', width: '50px',   },
	         				{ data: 'docCnt',    visible: true,  className: 'dt-body-center', width: '50px',   },
		...
		function modal_key_hidden(flag) {	
	        ...
	        const inputs = [hospCdInput, startYmInput];
	        if (flag !== 'I') {
		...
		function validateForm() {
		    const results = formValCheck(inputZone.id, {
		    	startYm:       { kname: "적용년월", k_req: true, k_spc: true, k_clr: true },
