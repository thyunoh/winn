...
<style>
								...
								<div class="col-3 col-lg-3">
                                   <div class="input-group">								
								 	<input id="hospCd" name="hospCd" type="text"
					    				class="form-control text-left" placeholder="요양기관등록">
										<button id = "hospserch"    class="btn btn-outline-info" "><i class="fas fa-search">검색</i>
										</button>
								   </div>	
								</div>	
								<label for="startYy" class="col-1 col-lg-1 col-form-label d-flex align-items-center justify-content-center">해당년도</label>
								<div class="col-2 col-lg-2">	
								    <input id="startYy" name="licNum" type="text"
	  ...
	  //원너넷이 아니거나 워너넷에서 병원을 선택해서 처리한 경우)
		...
		<!-- 공통코드 Setting End -->
		<!-- ============================================================== -->
		var format_convert = ['wardEnddt','lastWorkdt'] ; //날자에서 '-' '/' 제외설정   
