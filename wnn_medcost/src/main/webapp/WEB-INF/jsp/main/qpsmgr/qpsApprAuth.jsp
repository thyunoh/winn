...
<div class="aa-note">
  ★<b>맨 윗줄 「이 부서 기본」 한 줄이면 그 부서 서식 전부가 정해집니다.</b> 서식 줄은 비워 두면 그 기본을 따릅니다.<br>
  · <b>칸마다 여러 사람</b>을 넣을 수 있습니다(대리·교대). 그중 한 사람이 찍으면 그 칸이 채워집니다.<br>
  · 서식 줄에 사람을 넣으면 <b>그 칸만</b> 기본을 이깁니다 — 나머지 칸은 그대로 부서 기본을 따릅니다.<br>
  <b>지정이 하나도 없는 칸은 종전처럼 누구나</b> 결재할 수 있습니다 — 도입하는 날 결재가 멈추지 않게 한 것입니다.
</div>
