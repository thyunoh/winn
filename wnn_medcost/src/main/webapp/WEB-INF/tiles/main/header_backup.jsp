...
<body> 
  <nav class="navbar navbar-expand-lg bg-primary-v1 gnb-container"> 
    <div class="container-fluid">
         <div class="logo-wrap">  <!--  <a href="/main.do">    -->
               <img src="/asset/img/logo_01.png" alt="allCare" /></a> 
         </div> 
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
			...
			<c:if test="${sessionScope['q_admin_yn'] == 'D'}">
	          	<li class="menu-item " data-menu="01">
		           	<a href=  "/doctor/ptList.do"><button id="myButton"  class="btn" type="button">회원 관리</button></a>  
	          	</li>
	          	<li class="menu-item " data-menu="02">
