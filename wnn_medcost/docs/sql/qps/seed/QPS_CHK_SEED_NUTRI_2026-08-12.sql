...
INSERT INTO TBL_QPS_CHK_ITEM (FORM_ID, HOSP_CD, SORT, ITEM_NM, GRP_NM, DESC_TXT, INPUT_GB, UNIT_NM, USE_YN) VALUES
 ...
 ('NUT004','*', 4,'냉장 ＆ 냉동고'             ,'매일'  ,'정리정돈 (물기제거)'                        ,'CHECK',NULL,'Y'),   -- 2026-09-02 원본(Meal_Chart_005) 대조 : 전각 ＆ 보존
 ...
 ('NUT004','*',13,'배기 후드'                 ,'1주일'  ,'중성세제로 세척, 마른걸레로 닦기'             ,'CHECK',NULL,'Y'),
 ('NUT004','*',14,'배기후드, 가스버너'          ,'1주일'  ,'중성세제로 세척, 마른걸레로 닦기'             ,'CHECK',NULL,'Y'),
 ('NUT004','*',15,'배기후드, 조리대'           ,'1주일'  ,'중성세제로 세척, 마른걸레로 닦기'             ,'CHECK',NULL,'Y'),
 ('NUT004','*',16,'3단 취사 밥솥'             ,'1주일'  ,'중성세제로 세척, 마른걸레로 닦기'             ,'CHECK',NULL,'Y'),
 ('NUT004','*',17,'배기팬'                    ,'1주일'  ,'중성세제로 세척, 마른걸레로 닦기'             ,'CHECK',NULL,'Y'),
 ('NUT004','*',18,'전처리선반/전치리씽크대'      ,'1주일'  ,'중성세제로 세척, 마른걸레로 닦기'             ,'CHECK',NULL,'Y'),
 ('NUT004','*',19,'배식대/전처리쌩크대'         ,'1주일'  ,'중성세제로 세척, 마른걸레로 닦기'             ,'CHECK',NULL,'Y'),
 ('NUT004','*',20,'설거지 씽크대, 선반'         ,'1주일'  ,'중성세제로 세척, 마른걸레로 닦기'             ,'CHECK',NULL,'Y'),
 ('NUT004','*',21,'배식카 청소'                ,'1주일'  ,'중성세제로 세척'                            ,'CHECK',NULL,'Y'),
