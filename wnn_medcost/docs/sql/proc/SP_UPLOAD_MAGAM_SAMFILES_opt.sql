-- ============================================================================
-- SP_UPLOAD_MAGAM_SAMFILES 성능 최적화 버전 (2026-07-09)
...
DROP PROCEDURE IF EXISTS SP_UPLOAD_MAGAM_SAMFILES_OPT $$

CREATE DEFINER=`winner`@`%` PROCEDURE `SP_UPLOAD_MAGAM_SAMFILES_OPT`(
