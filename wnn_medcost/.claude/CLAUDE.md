...
***★[2026-08-14 마감 지시] 다음 재개 = 사진첨부 구현*** — 인수인계 **§5-4** 에 순서·파일·검증법이 조준돼 있다
(집 PC 에서 진행. 사무실 PC 작업분은 전부 커밋됨).
...
- ⚠**DB 는 08-14 분까지 운영 적용 완료** — `docs/sql/QPS_*` 시드를 다시 돌리지 말 것(병원이 고친 서식이 되돌아간다).
  **예외 1건** — `QPS_SAFERPT_SEED_DRUGRTN_2026-08-14.sql` 은 **확인 2건이 끝나야** 돌린다(머리말에 ⛔ 표시).
