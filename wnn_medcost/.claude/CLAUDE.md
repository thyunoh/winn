...
- **[2026-08-14] `safeRpt` 확장** — 반복행 표·서명란·정형문구를 더했다(사고·고장 보고 계열을 유형 추가로 흡수하려는 것).
  ...
  ⚠**실동작 미검증 · DDL 미적용** — 08-14 인수인계 §0·§5.
...
- ⚠**DB 는 08-13 분까지 운영 적용 완료** — `docs/sql/QPS_*` 시드를 다시 돌리지 말 것(병원이 고친 서식이 되돌아간다).
  **단 08-14 분(`QPS_DDL_SAFERPT_ROWSIGN`)은 아직 안 돌렸다** — 이것만 돌리면 된다.
